...
export const faqScreen = async (ctx) => {
    const message = `Хочешь связаться с поддежкой? Но сначала прочитай внимательно FAQ (ответы на часто задаваемые вопросы)
Возможно мы уже ответили на твой вопрос. Если не нашел ответю. Напиши нам и мы обязательно ответим.`;
