...
const keyboard = [
    [{ text: '🎁 Получить 10 промтов', command: 'prompt_link' }],
    [{ text: '⏪ Вернуться назад', command: 'back' }],
];

export const freePromptsScreen = async (ctx, editMessage) => {
    const message = `Мы подготовили ТОП-10 бесплатных фото промтов. Это твой первый шаг к созданию крутого ИИ-контента без вложений.`;
