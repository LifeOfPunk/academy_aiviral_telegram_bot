...
export const freeLessonStartScreen = async (ctx, editMessage) => {
    const message = `😎 Чтобы получить бесплатный видеоурок подпишись на Telegram-канал.
  
Так ты помогаеншь себе и нам расти, а также не пропустишь ценную информацию ИИ рынка.`;
