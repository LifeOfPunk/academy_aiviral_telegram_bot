export const GLOBAL_CONFIG = {
    tariffs: {
        start: {
            ...
            usdt: 3,
            rub: 50,
            offerIdLavaGift: '8d9bbf4d-ed9e-4836-91d9-122c79da3adc',
        },
        pro: {
            title: 'Pro',
            emoji: `😎`,
            usdt: 4,
            rub: 52,
            offerIdLavaGift: '61001e64-621b-4354-bbe6-3d809c12ac97',
        },
        premium: {
            title: 'Premium',
            emoji: `👑`,
            usdt: 5,
            rub: 55,
            offerIdLavaGift: 'c7186167-2423-46de-81ba-de1c4830563d',
        },
    },
    ...
    supportedCrypto: {
        ...
        USDT: [
            {
                name: 'USDT (ERC20)',
                processing: 'USDT (ERC20)',
                chainName: 'Ethereum Mainnet',
            },
            {
                name: 'USDT (TRC20)',
                processing: 'USDT (TRC20)',
                chainName: 'Tron',
            },
            {
                name: 'USDT (BEP20)',
                processing: 'USDT (BEP20)',
                chainName: 'Binance Smart Chain',
            },
            {
                name: 'USDT (POLYGON)',
                processing: 'USDT (POLYGON)',
                chainName: 'Polygon',
            },
            {
                name: 'USDT (ARB)',
                processing: 'USDT (ARB1)',
        ...
        USDC: [
            {
                name: 'USDC (ERC20)',
                processing: 'USDC (ERC20)',
                chainName: 'Ethereum Mainnet',
            },
            {
                name: 'USDC (BEP20)',
                processing: 'USDC (BEP20)',
                chainName: 'Binance Smart Chain',
            },
            {
                name: 'USDC (AVAXC)',
                processing: 'USDC (AVAXC)',
                chainName: 'Avalanche',
            },
            {
                name: 'USDC (POLYGON)',
                processing: 'USDC (POLYGON)',
                chainName: 'Polygon',
            },
            {
                name: 'USDC.e (ARB)',
                processing: 'Bridged USDC (ARB1) (USDC.e)',
                chainName: 'Arbitrum One',
            },
            {
                name: 'USDC (BASE)',
                processing: 'USDC (BASE)',
                chainName: 'Base',
            },
        ],
        TON: [{ name: 'TON', processing: 'TON', chainName: 'TON' }],
    },
};
...
export const ERROR_PAYMENT_CANCELLED = (wallet, tariff) => {
    ...
    console.log(`t = ${t}`);
    console.log(`global ` + GLOBAL_CONFIG.tariffs);
    console.log(`tariffFunc ` + tariff);
...
export const PAY_BY_CARD_ASK_EMAIL =
    'Пожалуйста, отправьте ваш НАСТОЯЩИЙ email:';
...
export const PAY_BY_CARD_ERROR_EMAIL_NOT_CORRECT =
    '❌ Некорректный email. Пожалуйста, попробуйте снова';
